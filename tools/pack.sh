...
# ── per-component knobs ──────────────────────────────────────────────────────
ID=lumen-imageviewer             # herald package id (== repo name)
NAME="Image viewer"              # human-readable name
DESTBIN=apps/imageviewer/imageviewer  # where the binary installs (verbatim runtime path)
